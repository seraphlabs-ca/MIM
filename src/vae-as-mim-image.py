...
from cond_pixelcnn.utils.optimizer import AdamNormGrad
...
parser.add_argument('--model_name', type=str, default='vae', metavar='MN',
                    help='model name: vae, hvae_2level, convhvae_2level, convhvae_2level-mim, convhvae_2level-amim, convhvae_2level-smim, pixelhvae_2level, pixelhvae_2level-mim, pixelhvae_2level-amim, pixelhvae_2level-smim')
...
parser.add_argument('--dataset_name', type=str, default='freyfaces', metavar='DN',
                    help='name of the dataset: static_mnist, dynamic_mnist, omniglot, caltech101silhouettes, histopathologyGray, freyfaces, cifar10, dynamic_fashion_mnist')
...
def run(args, kwargs):
    args.model_signature = str(datetime.datetime.now())[0:19].replace(" ", "_").replace(":", "-")

    model_name = args.dataset_name + '_' + args.model_name + '_' + args.prior + \
        '__K_' + str(args.number_components) + '__' + 'wu_' + str(args.warmup) + '__' + \
        'z1_' + str(args.z1_size) + '_z2_' + str(args.z2_size)
    ...
    if args.model_name == 'vae':
        from cond_pixelcnn.models.VAE import VAE
    elif args.model_name == 'hvae_2level':
        from cond_pixelcnn.models.HVAE_2level import VAE
    elif args.model_name == 'convhvae_2level':
        from cond_pixelcnn.models.convHVAE_2level import VAE
    elif args.model_name == 'convhvae_2level-mim':
        from cond_pixelcnn.models.convHVAE_2level import MIM as VAE
    elif args.model_name == 'convhvae_2level-amim':
        from cond_pixelcnn.models.convHVAE_2level import AsymMIM as VAE
    elif args.model_name == 'convhvae_2level-smim':
        from cond_pixelcnn.models.convHVAE_2level import SymMIM as VAE
    elif args.model_name == 'pixelhvae_2level':
        from cond_pixelcnn.models.PixelHVAE_2level import VAE
    elif args.model_name == 'pixelhvae_2level-mim':
        from cond_pixelcnn.models.PixelHVAE_2level import MIM as VAE
    elif args.model_name == 'pixelhvae_2level-amim':
        from cond_pixelcnn.models.PixelHVAE_2level import AsymMIM as VAE
    elif args.model_name == 'pixelhvae_2level-smim':
        from cond_pixelcnn.models.PixelHVAE_2level import SymMIM as VAE
    else:
    ...
    from cond_pixelcnn.utils.perform_experiment import experiment_vae
