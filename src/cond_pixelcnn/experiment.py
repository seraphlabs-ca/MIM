...
parser.add_argument('--model_name', type=str, default='vae', metavar='MN',
                    help='model name: vae, hvae_2level, convhvae_2level, pixelhvae_2level, pixelhvae_2level-mim')
...
def run(args, kwargs):
    ...
    model_name = args.dataset_name + '_' + args.model_name + '_' + args.prior + \
        '(K_' + str(args.number_components) + ')' + '_wu(' + str(args.warmup) + ')' + \
        '_z1_' + str(args.z1_size) + '_z2_' + str(args.z2_size)
    ...
    if args.model_name == 'vae':
        ...
        from models.PixelHVAE_2level import MIM as VAE
    else:
